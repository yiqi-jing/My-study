...
* **Project based on pyecharts 2.1.0**
...
* The visual data views generated by pyecharts in version 2.1.0 are compared with the official charts, and the functions that can be achieved and those that cannot be achieved are listed
