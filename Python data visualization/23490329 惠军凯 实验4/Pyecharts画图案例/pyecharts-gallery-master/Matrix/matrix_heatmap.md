...
c = (
    ...
    .set_global_opts(
        visualmap_opts=opts.VisualMapOpts(
            type_="continuous", max_=1, min_=-1, dimension=2,
            is_calculable=True, orient="horizontal", pos_top=5, pos_left="center",
        ),
...
<iframe width="100%" height="800px" src="Matrix/matrix_heatmap.html"></iframe>
