error id: file:///F:/Java/hello/src/ne.java
file:///F:/Java/hello/src/ne.java
...
```java
offset: 488
uri: file:///F:/Java/hello/src/ne.java
text:
```scala
...
class Solution {
    ...
    private v@@oid dfs(int i, List<String> ans, char[] path, char[] digits) {
        if (i == digits.length) {
...
QDox parse error in file:///F:/Java/hello/src/ne.java