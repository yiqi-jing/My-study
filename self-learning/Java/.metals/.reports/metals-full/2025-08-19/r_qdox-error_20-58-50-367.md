error id: file:///F:/Java/hello/src/new.java
file:///F:/Java/hello/src/new.java
...
```java
offset: 8
uri: file:///F:/Java/hello/src/new.java
text:
```scala
class `n@@ew` {
...
QDox parse error in file:///F:/Java/hello/src/new.java